...
?>
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="pull-right">
            <a href="<?= base_url('media/add_sku'); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus-circle"></i> Buat Surat</a>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body table-responsive">
          <div class="input-group input-group-sm" style="width: 100px;">
            <select name="tahun" id="tahun_sku" class="form-control">
          ...
          <br>
          <table id="table_sku" class="table table-striped">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background-color: #606060; color: white;">
          ...
          <h4 class="modal-title">Detail Surat SKU</h4>
        </div>
        <div class="modal-body" id="modal-sku">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-outline btn-sm" id="hapus_sku">Hapus</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      //Tampil SKU
      var table_sku = $('#table_sku').DataTable({
        "processing": true,
        "serverside": true,
        "ajax": "<?= site_url('action/get_sku')?>",
        "order": [[ 0, "desc" ]]
      });
      
      //Auto reload SKU
      setInterval( function () {
          table_sku.ajax.reload(null, false);
      }, 10000 );
    });
  </script>