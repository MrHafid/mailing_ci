...
<body>
	<div align="center">
		...
		<h4 style="margin-top: -18px;"><b><u>SURAT KETERANGAN CATATAN KEPOLISIAN</u></b></h4>
		<h4 style="margin-top: -18px;"><b>Nomor: </b><b><?php echo $skck[0]->no_surat; ?></b></h4>
	</div>
	...
	<p>
	    Nama tersebut diatas adalah betul penduduk warga desa kami berdasarkan keterangan dari RT/RW setempat, selanjutnya diterangkan pula bahwa yang bersangkutan adalah berkelakuan baik. Surat Keterangan ini digunakan sebagai <em>Pengantar Proses Pembuatan SKCK</em>.
	</p>
	<p>
		Demikian keterangan ini kami buat dengan sebenarnya agar pihak yang berkepentingan dapat mengetahuinya.
	</p>
	...
	<table style="width: 100%;">
		<tr>
			<td>
				...
				<img style="margin-left: 50px;" width="80" height="80" src="assets/qrcode/<?php echo cetak($skck[0]->qrcode); ?>">
				<?php } ?>
			</td>
			<td width="280">
				...
				<center><img src="assets/qrcode/<?php echo cetak($skck[0]->qrcode); ?>" width="80" height="80"></center>
				<p align="center">
