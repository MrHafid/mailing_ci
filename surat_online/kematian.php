    ...
    <section class="content">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Surat Keterangan Kematian</h3>
          <div class="pull-right">
            <a href="<?= base_url('media/add_kematian'); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus-circle"></i> Buat Surat</a>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body table-responsive">
          <div class="input-group input-group-sm" style="width: 100px;">
            <select name="tahun" id="tahun_kematian" class="form-control">
          ...
          <br>
          <table id="table_kematian" class="table table-striped">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background-color: #606060; color: white;">
          ...
          <h4 class="modal-title">Detail Surat Kematian</h4>
        </div>
        <div class="modal-body" id="modal-kematian">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-outline btn-sm" id="hapus_kematian">Hapus</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      var table_kematian = $('#table_kematian').DataTable({
        "processing": true,
        "serverside": true,
        "ajax": "<?= site_url('action/get_kematian')?>",
        "order": [[ 0, "desc" ]]
      });
      
      //Auto reload kematian
      setInterval( function () {
          table_kematian.ajax.reload(null, false);
      }, 10000 );
    });
  </script>