...
<body>
	<div align="center">
		...
		<h4 style="margin-top: -18px;"><b><u>SURAT KETERANGAN DOMISILI</u></b></h4>
		<h4 style="margin-top: -18px;"><b>Nomor: </b><b><?php echo $dom_warga[0]->no_surat; ?></b></h4>
	</div>
	...
	<table style="width: 100%;">
		<tr>
			<td>
				...
				<img style="margin-left: 50px;" width="80" height="80" src="assets/qrcode/<?php echo cetak($dom_warga[0]->qrcode); ?>">
				<?php } ?>
			</td>
			<td width="280">
				...
				<center><img src="assets/qrcode/<?php echo cetak($dom_warga[0]->qrcode); ?>" width="80" height="80"></center>
				<p align="center">
