...
<body>
	<div style="width: 700px; margin-right: auto; margin-left: auto;">
		...
		<div align="center">
			...
			<h4 style="margin-top: -18px;"><u>SURAT KETERANGAN TIDAK MAMPU</u></h4>
			<h4 style="margin-top: -18px;">Nomor: <?php echo cetak($sktm[0]->no_surat); ?></h4>
		</div>
		...
		<table style="width: 100%;">
			<tr>
				<td>
					...
					<img style="margin-left: 50px;" width="80" height="80" src="<?= base_url(); ?>assets/qrcode/<?php echo cetak($sktm[0]->qrcode); ?>">
					<?php } ?>
				</td>
				<td width="280">
					...
					<center><img src="<?= base_url(); ?>assets/qrcode/<?php echo cetak($sktm[0]->qrcode); ?>" width="80" height="80"></center>
					<p align="center">
