  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <?php foreach($dom_skolah->result() as $item){ ?>
        <?= form_open('action/update_dom_skolah'); ?>
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="nama_lembaga" class="form-control" placeholder="Nama Lembaga" value="<?php echo cetak(ucwords($item->nama_lembaga)); ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="jenis_lembaga" class="form-control" placeholder="Jenis Lembaga" value="<?php echo cetak($item->jenis_lembaga); ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea name="alamat_skolah" class="form-control" id="alamat_skolah" placeholder="Alamat Sekolah"><?php echo cetak(ucwords($item->alamat_skolah)); ?></textarea>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="nama_ket_lembaga" class="form-control" placeholder="Nama Ket. Lembaga" value="<?php echo cetak(ucwords($item->nama_ket_lembaga)); ?>" readonly="readonly">
              </div>
            </div>
