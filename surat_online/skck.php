...
?>
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="pull-right">
            <a href="<?= base_url('media/add_skck'); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus-circle"></i> Buat Surat</a>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body table-responsive">
          <div class="input-group input-group-sm" style="width: 100px;">
            <select name="tahun" id="tahun_skck" class="form-control">
          ...
          <br>
          <table id="table_skck" class="table table-striped">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background-color: #606060; color: white;">
          ...
          <h4 class="modal-title">Detail Surat SKCK</h4>
        </div>
        <div class="modal-body" id="modal-skck">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-outline btn-sm" id="hapus_skck">Hapus</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      //Tampil SKCK
      var table_skck = $('#table_skck').DataTable({
        "processing": true,
        "serverside": true,
        "ajax": "<?= site_url('action/get_skck')?>",
        "order": [[ 0, "desc" ]]
      });
      
      //Auto reload SKCK
      setInterval( function () {
          table_skck.ajax.reload(null, false);
      }, 10000 );
    });
  </script>
