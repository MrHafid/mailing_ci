  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <?= form_open('action/input_dom_ormas'); ?>
          <div class="box-body">
            <div class="form-group">
              <label for="" class="col-sm-2 control-label">Nama Ormas</label>

              <div class="col-sm-9">
                <input type="text" name="nama_ormas" class="form-control" placeholder="Nama Ormas">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea name="alamat_ormas" class="form-control" id="alamat_ormas" placeholder="Alamat Ormas"></textarea>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="cari_nik_dom_ormas" class="form-control" id="cari_nik_dom_ormas" placeholder="Cari NIK">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="nama_pimpinan" class="form-control" placeholder="Nama Pimpinan" readonly="readonly">
                <small style="color: red;"><?= form_error('nama_pimpinan','*'); ?></small>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea name="alamat_pimpinan" class="form-control" id="alamat_pimpinan" placeholder="Alamat Pimpinan" readonly="readonly"></textarea>
                <small style="color: red;"><?= form_error('alamat_Pimpinan','*'); ?></small>
              </div>
            </div>
            <div class="form-group">
