...
?>
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="pull-right">
            <a href="<?= base_url('media/add_sktm'); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus-circle"></i> Buat Surat</a>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body table-responsive">
          ...
          <br>
          <table id="table_sktm" class="table table-striped">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      //Tampil SKTM
      var table_sktm = $('#table_sktm').DataTable({
        "processing": true,
        "serverside": true,
        "ajax": "<?= site_url('action/get_sktm')?>",
        "order": [[ 0, "desc" ]]
      });
      
      //Auto reload SKCK
      setInterval( function () {
          table_sktm.ajax.reload(null, false);
      }, 10000 );
    });
  </script>
